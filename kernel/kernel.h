...
uintptr_t allocate_free_physical_page(void);
...
//Kernel Memory Size
#define KERNEL_MEMORY_SIZE (PROC_START_ADDR - KERNEL_START_ADDR)

// User Space Start
#define USER_SPACE_START    PROC_START_ADDR 

// User Space End
#define USER_SPACE_END      MEMSIZE_VIRTUAL
